===Сделал
Добавил кавычки к именам квадратов. Оператор #DQUOTE$
Переместил #canva в результирующей процедуре наверх. Добавил туда же #Squares2btns Пришлось подключить еще один файл. Не придумал как сделать проще
Генератор кода теперь работает, если не считать необходимости удалять комментарии с названиями файлов
